...
class ezTweet {
   ...
   // Your Twitter App Consumer Key
	...
	public function __construct() {
		...
		$this->consumer_key = get_field('consumer_key', 'option');
		$this->consumer_secret = get_field('consumer_secret', 'option');
		$this->user_token = get_field('access_token', 'option');
		$this->user_secret = get_field('access_token_secret', 'option');

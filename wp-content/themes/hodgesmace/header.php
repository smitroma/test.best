  ...
  <div class="container-fluid">
		<div id="top-header">
			<div class="container">
				...
				<button class="vc_general vc_btn3 vc_btn3-size-md vc_btn3-shape-rounded vc_btn3-style-modern bttn-orange m-l-sm requestDemoBtn btn-control">Request a Demo</button>
			</div>
		</div>
    <div id="header">
      <div class="container">
